...
public class StriderFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    private static ResourceKey<LootTable> STRIDER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/strider"));
