...
public class PufferfishFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {  
  ...
  private static ResourceKey<LootTable> PUFFERFISH_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/pufferfish"));  
